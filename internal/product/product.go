...
func Attributions() []string {
	return []string{
		...
		// NFR-LEG-002: CC BY 4.0 asks for the source, the copyright notice, the
		// licence and a note of changes (R13); confirmed by the owner (ASM-011).
		"Burnt areas: © European Union, Global Wildfire Information System (GWIS), Copernicus Emergency Management Service, CC BY 4.0; redrawn over the globe.",
